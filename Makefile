...
test-vagrant:
	...
	testinfra --hosts=base_packages_trusty --ssh-config=.vagrant/ssh-config --noconftest --sudo
	testinfra --hosts=base_packages_xenial --ssh-config=.vagrant/ssh-config --noconftest --sudo
